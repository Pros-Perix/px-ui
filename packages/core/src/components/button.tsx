...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors disabled:cursor-not-allowed shrink-0 [&_svg]:shrink-0 outline-none",
  {
    variants: {
      ...
      size: {
        default: "px-5 h-10 text-ppx-base font-medium rounded-ppx-s",
        sm: "gap-1.5 px-4 h-8 text-ppx-sm font-medium rounded-ppx-s",
        lg: "px-6 text-ppx-base font-bold rounded-ppx-m",
