...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input dark:bg-input/30 rounded-md shadow-xs relative flex w-full items-center border transition-[color,box-shadow] outline-none",
