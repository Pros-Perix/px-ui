...
Header component for floating windows and sidebars. Must be inside `XandiProvider`. Avatar and title come from context config; New Chat uses `startNewConversation` from context.
