...
<CodeBlock>
```tsx
<BlockCheckboxGroup.Group defaultValue={["email"]} className="grid grid-cols-2">
...
<CodeBlock>
```tsx
<BlockCheckboxGroup.Group defaultValue={["react", "typescript", "tailwind"]} className="grid grid-cols-3">
