import { Sidebar, Button } from "@px-ui/core";
      ...
      <Sidebar.Provider>
        ...
        <Sidebar.Inset>
          <header className="flex h-12 items-center gap-2 border-b border-ppx-neutral-3 px-4">
            <Sidebar.Trigger />
            <span className="text-ppx-sm font-sans-sb">Dashboard</span>
          </header>
          <div className="flex-1 p-4">
            <p className="text-ppx-sm text-ppx-muted-foreground">Main content area</p>
          </div>
        </Sidebar.Inset>
      </Sidebar.Provider>
    </div>
